...
{
    [DbContext(typeof(Alfa5TenantDbContext))]
    partial class Alfa5TenantDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alfa5.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Volo.CmsKit.PageFeedbacks.PageFeedbackSetting", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EntityType")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL AND [EntityType] IS NOT NULL");
