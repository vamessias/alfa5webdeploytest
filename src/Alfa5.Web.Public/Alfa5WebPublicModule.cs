...
public class Alfa5WebPublicModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(Alfa5WebPublicModule).Assembly
            );
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<Alfa5WebPublicModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<Alfa5WebPublicModule>();
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<Alfa5ApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}Alfa5.Application.Contracts", Path.DirectorySeparatorChar)));
                options.FileSets.ReplaceEmbeddedByPhysical<Alfa5WebPublicModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureNavigationServices(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new Alfa5PublicMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new Alfa5ToolbarContributor());
        });
    }
