...
public class Alfa5DomainModule : AbpModule
{
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<Alfa5Resource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<Alfa5Resource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
